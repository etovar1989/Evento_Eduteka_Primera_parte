...
public class dia2Resultado extends AppCompatActivity implements Response.ErrorListener, Response.Listener<JSONObject>{

    TextView txtResultado;
    TextView dato;
    String documento, id, tipo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        validarCedula(documento,id,tipo);
    ...
    private void validarCedula(String documento, String id, String tipo ) {
        String url="https://www.eventoeduteka.com/2020/complementosApk/dia2.php?idU="+documento+"&idTipo="+id+"&tipo="+tipo;
    ...
    public void alertErrorRecord() {
        ...
        new AlertDialog.Builder( dia2Resultado.this)
                .setTitle("Opss")
